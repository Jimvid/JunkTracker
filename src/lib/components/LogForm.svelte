...
<form class="rounded-lg border border-gray-300 bg-white p-6 shadow-sm" method="POST" action="?/addLog">
	<h2 class="mb-4 text-lg font-semibold text-gray-900">Add Log</h2>
	...
	<div class="flex flex-col gap-3 md:flex-row md:items-end">
		...
		<div class="flex flex-row gap-3">
			...
			<label class="flex flex-1 items-center gap-2 rounded-lg border border-gray-300 p-3 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50" for="junkfree">
				<input

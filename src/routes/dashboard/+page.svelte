...
<section class="flex flex-col gap-3 md:gap-6">
	...
	<div class="grid grid-cols-1 gap-4 md:grid-cols-3">
		...
		<div class="rounded-lg border border-gray-300 bg-white p-6 shadow-sm">
			<div class="flex items-center justify-between">
				<div>
					...
					<p class="mt-2 text-3xl font-bold text-gray-900">{data.numberOfContributions}</p>
		...
		<div class="rounded-lg border border-gray-300 bg-white p-6 shadow-sm">
			<div class="flex items-center justify-between">
				<div>
					<p class="text-sm font-medium text-gray-600">Junk-Free Streak</p>
					<p class="mt-2 text-3xl font-bold text-gray-900">{currentStreak}</p>
		...
		<div class="rounded-lg border border-gray-300 bg-white p-6 shadow-sm">
			<div class="flex items-center justify-between">
				<div>
					<p class="text-sm font-medium text-gray-600">Junk-Free Days</p>
					<p class="mt-2 text-3xl font-bold text-gray-900">{junkFreeDays}</p>
					<p class="mt-1 text-xs text-gray-500">This year</p>
				</div>
	...
	<div class="flex flex-col gap-2">
		...
		<div class="flex flex-col rounded-[4px] border border-black md:hidden">
			<!-- Month navigation header -->
			<div class="flex items-center justify-between border-b border-black p-3">
				<button

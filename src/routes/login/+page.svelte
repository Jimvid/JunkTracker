<section class="flex min-h-[80vh] flex-col items-center justify-center py-12">
	<div class="w-full max-w-md rounded-lg bg-white p-8 shadow-sm">
		<div class="mb-6 flex flex-col items-center gap-4">
			...
			<p class="text-center text-sm text-gray-600">Sign in to track your junk food intake</p>
		</div>

		<div class="flex justify-center">
			<a
				class="flex w-full items-center justify-center gap-2 rounded-lg bg-blue-600 px-6 py-3 text-base font-semibold text-white shadow-sm transition-colors hover:bg-blue-700 active:bg-blue-800"
				href="/login/google"
			>
